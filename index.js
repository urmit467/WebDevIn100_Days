...
function fillTable() {
    const data = [
        ...
        ["Day 10", "WeatherApp (by Kushagra Chavel)", "./public/WeatherApp/index.html"],
        ["Day 11", "Countdown Banner (by Priyanshi)", "https://countdown-banner.vercel.app/"],
        ["Day 12", "Coin Flip Heads/Tails (by Radhika Dodain)", "./public/Coin_Flip/index.html"],
        ["Day 13", "E-waste Management Hub (by Abhirup Nandi)", "https://e-waste-management-hub.netlify.app/"],
        ["Day 14", "Currency Converter (by Maulik Gupta)", "./Currency_Converter/index.html"],
        ["Day 15", "Random User Generator (by Maulik Gupta)", "./Random_User_Generator/index.html"],
        ["Day 16", "Image Search App (by Maulik Gupta)", "./Image_Search_App/index.html"],
        ["Day 17", "WaterMedic (By Dee)", "https://github.com/dipmanmajumdar/WaterMedic"],
        ["Day 18", "URL Shortener", "https://github.com/ANTIK-007/URL-Shortener"],
        ["Day 19", "Interactive Portfolio (by Priya Katariya)", "/public/portfolio/index.html"],
